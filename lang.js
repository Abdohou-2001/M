...
// Login page - extended
    ...
    signupDesc: "إنشاء حساب جديد",
    fullNamePlaceholder: "مصطفى أحمد",
    ...
    enterEmailAndPassword: "الرجاء إدخال البريد وكلمة المرور",
    invalidEmailFormat: "البريد غير صحيح",
    enterFullName: "الرجاء إدخال الاسم الكامل",
    otpConfirmAccount: "تأكيد إنشاء الحساب",
    otpSentTo: "تم إرسال رمز مكون من 6 أرقام إلى",
    otpEnter6Digits: "الرجاء إدخال رمز مكون من 6 أرقام",
    forgotPasswordTitle: "نسيت كلمة المرور؟",
    forgotPasswordDesc: "أدخل بريدك وسيصلك رابط رسمي من Firebase",
    forgotPasswordDescSimple: "أدخل بريدك الإلكتروني",
    ...
    openEmailInstruction: "افتح بريدك الإلكتروني واضغط على الرابط المرسل من Firebase.",
    afterNewPassword: "بعد إنشاء كلمة مرور جديدة يمكنك العودة إلى التطبيق وتسجيل الدخول مباشرة.",
    step1: "افتح بريدك الإلكتروني",
    step2: "افتح الرسالة القادمة من Firebase",
    step3: "اضغط على زر Reset Password",
    step4: "أدخل كلمة المرور الجديدة",
    step5: "احفظها واضغط Save",
    step6: "ارجع إلى تطبيق Karni Pro وسجل الدخول بكلمة المرور الجديدة",
    openEmail: "فتح البريد الإلكتروني",
    backToLogin: "العودة لتسجيل الدخول",
    resendCode: "إعادة إرسال الرمز",
    resendIn: "إعادة الإرسال ({sec}ث)",
    verificationCode: "رمز التحقق",
    chooseLanguage: "اختر اللغة",
    language: "اللغة",
    apply: "تطبيق",
    processingDots: "جاري المعالجة...",
  },
...
// Login page - extended
    ...
    signupDesc: "Créer un nouveau compte",
    fullNamePlaceholder: "Mustapha Ahmed",
    emailPlaceholder: "example@mail.com",
    passwordPlaceholder: "••••••••",
    minutes: "minutes",
    cancel: "Annuler",
    ...
    enterEmailAndPassword: "Veuillez entrer email et mot de passe",
    invalidEmailFormat: "Email invalide",
    enterFullName: "Veuillez entrer le nom complet",
    otpConfirmAccount: "Confirmer la création du compte",
    otpSentTo: "Code à 6 chiffres envoyé à",
    otpEnter6Digits: "Veuillez entrer un code à 6 chiffres",
    forgotPasswordTitle: "Mot de passe oublié?",
    forgotPasswordDesc: "Entrez votre email et vous recevrez un lien officiel de Firebase",
    forgotPasswordDescSimple: "Entrez votre email",
    sendLink: "Envoyer le lien",
    sentSuccessfully: "Envoyé avec succès",
    resetLinkSent: "Lien de réinitialisation envoyé à votre email",
    openEmailInstruction: "Ouvrez votre email et cliquez sur le lien envoyé par Firebase.",
    afterNewPassword: "Après avoir créé un nouveau mot de passe, vous pouvez revenir et vous connecter.",
    step1: "Ouvrez votre email",
    step2: "Ouvrez le message de Firebase",
    step3: "Cliquez sur Reset Password",
    step4: "Entrez le nouveau mot de passe",
    step5: "Enregistrez et cliquez Save",
    step6: "Revenez à Karni Pro et connectez-vous",
    openEmail: "Ouvrir l'email",
    backToLogin: "Retour à la connexion",
    resendCode: "Renvoyer le code",
    resendIn: "Renvoyer ({sec}s)",
